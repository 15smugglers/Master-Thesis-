#try to skip if possible (+dating)
makedata<-function(note,B,E,T) {
  ...
  #Here we bring cla and cil into the environment and we have to find a different way to do that 
  ...
  #print(sprintf("List lengths: %d ",ll))
  ########################################
