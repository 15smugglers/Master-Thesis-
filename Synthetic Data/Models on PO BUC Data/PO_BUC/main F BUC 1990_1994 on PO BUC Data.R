...
note=list()
note$RUNDIR="~/Downloads/Synthetic Data/Models on PO BUC Data/PO_BUC"
note$VERBOSE=FALSE
...
test_path <- "/Users/finnmaass/Downloads/Synthetic Data/Models on PO BUC Data/PO_BUC/example-FT-dir"
