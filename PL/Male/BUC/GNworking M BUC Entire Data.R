...
note$RUNDIR="C:/Users/fimaass/Downloads/PL/Entire Data/BUC/Male"
...
X <- PL_MCMC(D=D,M=M,wsigma=0.2,wtheta=0.1,sigmabeta=1.0,sigmalambda=1.0,SS=SS,B=B,E=E,d=10,a=0.5,b=0.5,theta0=thetahat,sigma0=sigmahat,beta0=betahat,lambda0=lambdahat)
