...
save_last_plot_pdf("fm_beta_acf_traceplot")
...
save_last_plot_pdf("fm_theta_traceplot")
#acf(thetamcmc,lag.max = 5000)

plot(thetamcmc,type='l',xlab="MCMC-sample",ylab = expression(theta))
acf(thetamcmc,lag.max = 5000,main="ACF of theta")
save_last_plot_pdf("fm_theta_acf_traceplot")


## lambda
plot(lambdamcmc[10,10,-c(1:1000)],type='l')
save_last_plot_pdf("fm_lambda_traceplot")
...
save_last_plot_pdf("fm_lambda_acf_traceplot")
...
save_last_plot_pdf("fm_beta_boxplot")
###################################################
boxplot(C[,1]~C[,2],xlab='seniority rank', 
