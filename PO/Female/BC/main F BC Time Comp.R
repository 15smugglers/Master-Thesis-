...
note=list()
note$RUNDIR="~/Downloads/Results_Thesis/PO/Entire Data/Female/BC"
note$VERBOSE=FALSE
...
note$constrainbeta=TRUE     #if TRUE then beta is contrained to be decreasing
...
#}
test_path <- "/Users/finnmaass/Downloads/Results_Thesis/PO/Entire Data/Female/BC/example-FT-a-dir"
