...
note=list()
note$RUNDIR="~/Downloads/Results_Thesis/PO/Entire Data/Female/BUC"
note$VERBOSE=FALSE
...
test_path <- "/Users/finnmaass/Downloads/Results_Thesis/PO/Entire Data/Female/BUC/example-FT-a-dir"

output=outputanalysis(out.dir=test_path,
