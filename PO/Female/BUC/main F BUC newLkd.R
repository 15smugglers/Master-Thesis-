...
note=list()
note$RUNDIR="C:/Users/fimaass/Downloads/MCMC Time Whole Make data modified/Female/BUC"
note$VERBOSE=FALSE
...
note$model='lkpairwise'           #'lkpairwise', 'bidir', 'lkddown' or 'lkdup' or 'lkdnat' or 'prior' or 'lkmallow' at the moment - 'prior' gives the joint prior of beta,theta,rho,U 
